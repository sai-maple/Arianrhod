...
namespace Arianrhod.Installer
{
    public class CharacterFactoryInstaller : MonoInstaller<CharacterFactoryInstaller>
    {
        ...
        {
            Container.BindFactory<int, Owner, CharacterEntity, CharacterView, CharacterView.Guanyu>()
            ...
            Container.BindFactory<int, Owner, CharacterEntity, CharacterView, CharacterView.Huanggai>()
                .FromPoolableMemoryPool<int, Owner, CharacterEntity, CharacterView, HuanggaiFactory>(poolBuilder =>
                    poolBuilder
                        ...
                        .UnderTransform(transform));
            Container.BindFactory<int, Owner, CharacterEntity, CharacterView, CharacterView.Huanyueing>()
                .FromPoolableMemoryPool<int, Owner, CharacterEntity, CharacterView, HuanyueingFactory>(poolBuilder =>
                    poolBuilder
                        ...
                        .UnderTransform(transform));
            Container.BindFactory<int, Owner, CharacterEntity, CharacterView, CharacterView.Lusu>()
                .FromPoolableMemoryPool<int, Owner, CharacterEntity, CharacterView, LusuFactory>(poolBuilder =>
                    poolBuilder
                        ...
                        .UnderTransform(transform));
            Container.BindFactory<int, Owner, CharacterEntity, CharacterView, CharacterView.Simayi>()
                .FromPoolableMemoryPool<int, Owner, CharacterEntity, CharacterView, SimayiFactory>(poolBuilder =>
                    poolBuilder
                        ...
                        .UnderTransform(transform));
            Container.BindFactory<int, Owner, CharacterEntity, CharacterView, CharacterView.Zhugeliang>()
